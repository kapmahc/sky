...
class WidgetF extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
     if (!err) {
       post('/admin/smtp', Object.assign({}, values, {port: parseInt(values.port, 10)}))
        .then((rst) => {
  ...
  render() {
    ...
    return (
      <Layout admin breadcrumbs={[{href: '/admin/smtp', label: <FormattedMessage id='site.admin.smtp.title'/>}]}>
