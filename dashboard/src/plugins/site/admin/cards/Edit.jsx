...
class WidgetF extends Component {
  ...
  render() {
    ...
    return (
      <Layout breadcrumbs={[
          {href: '/admin/cards', label: <FormattedMessage id='site.admin.cards.index.title'/>},
          {href: id ? `/admin/cards/edit/${id}` : '/admin/cards/new', label: <FormattedMessage id={id ? 'buttons.edit': 'buttons.new'}/>},
        ]}>
