...
import (
	...
	i_orm "github.com/kapmahc/sky/web/i18n/orm"
	"github.com/kapmahc/sky/web/job/rabbitmq"
	s_orm "github.com/kapmahc/sky/web/settings/orm"
	"github.com/kapmahc/sky/web/uploader/fs"
...
func (p *Plugin) Open(g *inject.Graph) error {
	...
	return g.Provide(
		...
		&inject.Object{Value: web.NewWrapper()},
