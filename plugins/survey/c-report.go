...
func (p *Plugin) getFormReport(c *gin.Context) error {
	...
	headers := []gin.H{
		gin.H{"name": "username", "label": p.I18n.T(lang, "survey.attributes.record.username")},
		gin.H{"name": "email", "label": p.I18n.T(lang, "survey.attributes.record.email")},
		gin.H{"name": "phone", "label": p.I18n.T(lang, "survey.attributes.record.phone")},
	}
